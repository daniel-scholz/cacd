...
from diffae.model.blocks.cond_resblock import (
    ConstCondResblockKwargs,
...
class DiffConfig(BaseConfig):
    ...
    # use resblock for upscale/downscale blocks (more expensive but higher quality)
