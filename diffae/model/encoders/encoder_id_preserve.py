...
if TYPE_CHECKING:
    from diffae.model.encoders.encoder_id_preserve_nonlinear import (
        EncoderIDPreserveModelNonLinear,
    )
...
class EncoderIDPreserveModel(BeatGANsEncoderModel):
    def _init_out_layer(self, conf: EncoderIDConfig, ch: int):
        ...
        smallest_feat_map_size = (
            4 if 64 == conf.image_size or 64 in conf.image_size else 8
        )
