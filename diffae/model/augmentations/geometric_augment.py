...
from monai.transforms.spatial.array import Rand2DElastic, Rand3DElastic, RandAffine, RandFlip
...
class GeometricAugment(nn.Module):
    ...
    def _setup_elastic(self, image_size, spatial_dims):
        elastic_spacing = self._calc_spacing_from_image_size(image_size, n_control_points=4)
        magnitude_range = (0, 1)
